  ...
  function fillVotesTbl(order, members) {
    ...
    if (order == "up") {
      ...
      members.sort(function (a, b) {
        ...
        var value1 = b.votes_with_party_pct - b.missed_votes_pct;
        var value2 = a.votes_with_party_pct - a.missed_votes_pct;
      ...
      members.sort(function (a, b) {
        var value1 = a.votes_with_party_pct - a.missed_votes_pct;
        var value2 = b.votes_with_party_pct - b.missed_votes_pct;
    ...
    for (var i = 0; i < members.length * 0.1; i++) {
      ...
      var numPartyVotes = members[i].total_votes - members[i].missed_votes;

      var row = document.createElement("tr");

      row.insertCell().innerHTML = fullname;
      row.insertCell().innerHTML = numPartyVotes;
      row.insertCell().innerHTML = (members[i].votes_with_party_pct - members[i].missed_votes_pct).toFixed(2);
